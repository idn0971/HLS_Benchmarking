proc dump_statistics {  } {
  ...
  file delete -force HLS_output//Synthesis/vivado_flow_0/alu_report.xml 
  set ofile_report [open HLS_output//Synthesis/vivado_flow_0/alu_report.xml w]
...
create_project alu -part xc7z020clg484-1 -force
read_verilog alu.v
read_xdc HLS_output//Synthesis/vivado_flow_0/alu.sdc
