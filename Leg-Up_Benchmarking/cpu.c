...
int main()
{
	...
	instMemory[0] = 0x20000113;
	instMemory[4] = 0x00400513;
	instMemory[8] = 0x008000ef;
	instMemory[12] = 0x0400006f;
	instMemory[16] = 0xff810113;
	instMemory[20] = 0x00112223;
	instMemory[24] = 0x00a12023;
	instMemory[28] = 0x00100293;
	instMemory[32] = 0x00555463;
	instMemory[36] = 0x0180006f;
	instMemory[40] = 0xfff50513;
	instMemory[44] = 0xfe5ff0ef;
	instMemory[48] = 0x00012583;
	instMemory[52] = 0x02b50533;
	instMemory[56] = 0x0080006f;
	instMemory[60] = 0x00100513;
	instMemory[64] = 0x00412083;
	instMemory[68] = 0x00810113;
	instMemory[72] = 0x00008067;
	instMemory[76] = 0x00a00b33;
	int32_t memory[8192];
	int32_t currInst = 0;
	int32_t nextInst = 0;
	int aluOpcode;
